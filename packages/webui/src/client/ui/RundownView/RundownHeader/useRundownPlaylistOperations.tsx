import { type SerializedUserError, UserError, UserErrorMessage } from '@sofie-automation/corelib/dist/error'
...
import { type UserPermissions, UserPermissionsContext } from '../../UserPermissions'
